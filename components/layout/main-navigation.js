...
const MainNavigation = () => {
    ...
    return (
        <div className="bg-gray-50 h-screen">
          <div className="bg-white xl:hidden flex text-gray-800  hover:text-black focus:outline-none focus:text-black justify-between w-full h-screen p-6 items-center ">
            <button className="flex justify-between  items-center space-x-3">
              ...
              <p className="text-2xl leading-6 ">AcadConnect</p>
            </button>
          ...
          <div id="Main" className={`${show ? "-translate-x-full" : "translate-x-0"} bg-white transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-72   flex-col h-full`}>
            ...
            <div className="xl:mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-3 pb-5 ">
              ...
              <button className="focus:outline-none flex jusitfy-start hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4 items-center space-x-6 w-full ">
                ...
                <p className="text-base leading-4 ">Tutors</p>
              </button>
            </div>
            ...
            <div className="mt-36 absolute bottom-0 bg-indigo-700 justify-start space-x-2 items-center py-4 px-3.5 w-full ">
              <div className="flex items-center space-x-2">
                <img class="object-cover h-12 w-12" src="https://friconix.com/png/fi-cnluxx-anonymous-user-circle.png" alt="avatar" />
