              ...
              <div className="w-full h-full bg-gray-200">
                  <div className="flex flex-no-wrap">
                      ...
                      <div className="fixed top-0 lg:relative w-64 min-h-screen shadow bg-gray-100 hidden lg:block">
                        <Link href={`/`}>
                          <div className="mt-5 w-full flex flex-col justify-center items-center px-8 text-transparent bg-clip-text bg-gradient-to-tl from-blue-950 to-blue-600">
                            <svg width={50} height={50} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-sky-950 fill-current">
                              <path
                            ...
                            <p className="mt-2 text-2xl leading-6 font-black">AcadConnect</p>
                          </div>
                        </Link>
